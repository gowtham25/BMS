...
<style>
    ...
    /* .trailer-container{
        ...
        grid-template-areas: "movie-container movie-container movie-container movie-container";
        padding: 10px;
        padding: 38px 60px;
    }
    @media (max-width: 1000px) and (min-width:670px){
        .trailer-container{
            ...
            grid-template-areas: "movie-container movie-container movie-container";
            padding: 10px;
        }
    }
    @media (max-width: 670px){
        .trailer-container{
            ...
            grid-template-areas: "movie-container movie-container";
            padding: 10px;
        }
    } */
    .movie-poster{
